...
namespace LanguageWidget
{
    ...
    public partial class WatermarkedTextbox : UserControl
    {
        ...
        {
            WatermarkedTextbox control = d as WatermarkedTextbox;
            if (null == control)
            {
                return;
            }

            string value = (null == e.NewValue) ? string.Empty : (string)e.NewValue;
        ...
        private void TextEntry_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            ICommand textChangedCommand = this.TextChangedCommand;
            if (null != textChangedCommand)
            {
                textChangedCommand.Execute(this.TextChangedCommandParameter);
            }
        }
    }
}